...
class _BusinessRegistrationPageState extends State<BusinessRegistrationPage> {
  ...
  String _selectedBusinessType = 'Supermarket';
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Terms and Privacy
                      Text(
                        'By registering, you agree to our Business Terms and Privacy Policy',
    ...
    return Center(
      child: Container(
        ...
        decoration: BoxDecoration(
          color: AppColors.secondaryOrangeLight.withOpacity(0.2),
